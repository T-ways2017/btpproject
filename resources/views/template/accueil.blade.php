...
<head>
    ...
    <meta name="keywords" content="btp construction service immobilier bitume " />
    <meta name="author" content="tways" />

    <!-- Page Title
    ================================================== -->
    <title>BTP || SERVICE </title>
    ...
    <link rel="stylesheet" href="{{asset('css/colors/color4.css')}}">
...
<div class="navbar navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><img class="logo" src="images/04_small-logo-color4.png" alt=""></a>
        </div>
        <!-- desktop menu -->
                    ...
                    <div class="process-steps-wrapper">
                        <div id="process-steps" class="process-steps">
                            <div class="icon process-block flex-active">
                                <img src="images/08_process-icon-color5.jpg" alt="" class="process-image" draggable="false">
                            </div>
                            <div class="icon process-block">
                                <img src="images/09_process-icon-color5.jpg" alt="" class="process-image" draggable="false">
                            </div>
                            <div class="icon process-block">
                                <img src="images/10_process-icon-color5.jpg" alt="" class="process-image" draggable="false">
                            </div>
                            <div class="icon process-block">
                                <img src="images/11_process-icon-color5.jpg" alt="" class="process-image" draggable="false">
                            </div>
                        </div>
                    </div>
...
<section id="services">
    ...
    <div class="getInTouch">
        <div class="getInTouch-bg parallax-bg">
            <div class="info-container">
                <div class="info">
                    <div class="container cbp-so-side cbp-so-side-top">
                        <a href="#" class="btn btn-outline-white btn-big">Let's work together</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2 livet">
                                ...
                                <div class="twitter_author"><a href="https://twitter.com/envato" target="_blank">
                                        <img class="twitter_img left pulsate-opacity" src="images/33_twitter5.png" alt=""></a></div>
                                <!-- tweets display -->
                                <div id="tweets">
                                </div>
                                <!-- End tweets display-->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2" id="contact-form">
                <!-- Contact form -->
                <form method="post" action="http://naiknikunj.me/naiknikunj/theme/3/get_mail.php">
                    <div class="_lines">
                        <div class="_line"></div>
                        <div class="_line"></div>
                        <div class="_line"></div>
...
<section id="style-switcher">
    <div>
        <h3>Index variant</h3>
        <a class="sw-page variant" href="index.html">Index-DEFAULT</a>
        <a class="sw-page" href="#">Index-VIDEO</a>
        <a class="sw-page" href="#">Index-SLIDER</a>
        <h3>Color palette</h3>
        <ul class="colors">
...
<script type="text/javascript" src="../../../public/js/jquery.funnyText.js"></script>
...
<script type="text/javascript" src="../../../public/js/parallaxInit.js"></script>
...
<script type="text/javascript" src="../../../public/js/carousel-slider.js"></script>
<script type='text/javascript' src="../../../public/js/jquery.magnific-popup.min.js"></script>
<script type="text/javascript" src="../../../public/js/jquery.flexslider-min.js"></script>
<script type="text/javascript" src="../../../public/js/jquery.easing.1.3.js"></script>
<script type="text/javascript" src="../../../public/js/tweetable.jquery.js"></script>
