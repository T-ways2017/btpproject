        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <!-- heading -->
                    <h1 style="opacity: 1; padding-top: 0px;" class="funny-text">BTP SERVICES &amp; CONSTRUCTOIN </h1>
                    <!-- ticker -->
                    <ul id="aboutme">
                        <li>Construction</li>
                        <li>Ponts &amp; Chaussées</li>
                        <li>Grands Traveaux</li>
                        <li>Ingenieurs</li>
                    </ul>
                    <!--social icon -->
                    <div class="social">
...
<section id="style-switcher">
    <div>
        ...
        <a class="sw-page" href="Birva-video/index.html">Index-VIDEO</a>
        <a class="sw-page" href="Birva-slider/index.html">Index-SLIDER</a>
        <h3>Color palette</h3>
        <ul class="colors">
            ...
            <li><a class="color5 active" href="index-color4.html"></a></li>
            ...
            <li><a class="color9" href="index-color8.html"></a></li>
